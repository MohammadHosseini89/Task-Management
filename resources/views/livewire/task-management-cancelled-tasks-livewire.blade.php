        ...
        <div class="card col-md-12">
            ...
            <div class="card-header p-2">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ route('cancelled') }}">Cancelled
                            Tasks</a></li>
                            ...
                            <div class="row justify-content-center col-md-12 mr-1 ml-2">
                                ...
                                <div class="col-md-3 col-12 ml-1 mr-1 mt-1" style="height: 20%; width: 30%">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" wire:model="edit_solution3"
                                            id="edit_solution3" name="edit_solution3" placeholder="Enter Status">
