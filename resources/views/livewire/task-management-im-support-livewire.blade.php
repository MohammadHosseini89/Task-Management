    ...
    <div class="row">
        ...
        <div class="card col-md-12">
            <div class="card-header p-2">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ route('support') }}">I'm Support</a></li>
            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Dispatchedbyme">
                        ...
                        <thead>
                            <tr>
                                <th style="vertical-align: middle;" colspan="1">Action</th>
                                <th style="vertical-align: middle;" colspan="1">Task ID</th>
                                {{-- <th style="vertical-align: middle;" colspan="2">Cancel Assigns</th> --}}
                                <th style="vertical-align: middle;" colspan="2">Issue</th>
                                <th style="vertical-align: middle;" colspan="1">Solution1</th>
                                <th style="vertical-align: middle;" colspan="1">Solution2</th>
                                <th style="vertical-align: middle;" colspan="1">Status</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($viewDetailsDispatchedByMe as $datadispatch)
                                <tr>
                                    <td colspan="1">
                                        ...
                                        @else
                                            ...
                                            <button class="btn btn-block btn-primary btn-xs"
                                                wire:click="editTaskManagementDataDispatch({{ $datadispatch->id }})">Feedback</button>
                                    ...
                                    <td colspan="2"> {{ $datadispatch->issue }} </td>
                                    <td colspan="1"> {{ $datadispatch->solution }} </td>
                                    <td colspan="1"> {{ $datadispatch->solution2 }} </td>
                                    <td colspan="1"> {{ $datadispatch->solution3 }} </td>
                            ...
                            <div class="row">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value=""
                                        id="task_fail" wire:model="task_fail">
                                    <label class="form-check-label" for="task_fail" style="color: rgb(204, 198, 213)">
        ...
        <div wire:ignore.self class="modal fade" id="editTaskModal" tabindex="-1" data-backdrop="static"
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Feedback Task Number:
                            @if (empty($modalDispatchedByMe->uuid))
                                ''
                            @else
                                {{ $modalDispatchedByMe->uuid }}
                        ...
                        <form wire:submit.prevent="editTaskData">
                            ...
                            <div class="row justify-content-center col-md-12 mr-1 ml-2">
                                ...
                                <div class="col-md-3 col-12 ml-1 mr-1 mt-1" style="height: 20%; width: 30%">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control"
                                            wire:model="edit_due_date" id="edit_due_date" name="edit_due_date" readonly
                                            style="background-color: rgba(10, 4, 27, 0.7); color:azure">
                                        @error('edit_due_date')
                                            <span class="text-danger"
                                                style="font-size: 11.5px;">{{ $message }}</span>
                                    ...
                                    <div class="input-group">
                                        ...
                                        @if (!empty($stringowner_edit))
                                            <input type="search" name="searchmodalownereditopen"
                                                ...
                                                placeholder="{{ $stringowner_edit }}" readonly
                                                style="background-color: rgba(10, 4, 27, 0.7); color:azure">
                                            {{-- wire:click="searchmodalownerfbopen" > --}}
                                        @else
                                            <input type="search" name="searchmodalownereditopen"
                                                id="searchmodalownerfbopen" class="form-control"
                                                placeholder="{{ $edit_owner }}" readonly
                                                style="background-color: rgba(10, 4, 27, 0.7); color:azure">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        @if (!empty($stringsupport_edit))
                                            <input type="search" name="searchmodalsupporteditopen"
                                                ...
                                                placeholder="{{ $stringsupport_edit }}" readonly
                                                style="background-color: rgba(10, 4, 27, 0.7); color:azure">
                                            {{-- wire:click="searchmodalsupportfbopen"> --}}
                                        @else
                                            <input type="search" name="searchmodalsupporteditopen"
                                                id="searchmodalsupporteditopen" class="form-control"
                                                placeholder="{{ $edit_support }}" readonly
                                                style="background-color: rgba(10, 4, 27, 0.7); color:azure">
                                            {{-- wire:click="searchmodalsupportfbopen"> --}}
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        value = {{ $edit_priority }}
                                        style="background-color: rgba(10, 4, 27, 0.7); color:azure"
                                            id="edit_priority" name="edit_priority" placeholder="Enter issue 1">
                                        @error('edit_priority')
                                            <span class="text-danger"
                                                style="font-size: 11.5px;">{{ $message }}</span>
                                        @enderror
                            ...
                            <div class="row justify-content-center col-md-12">
                                <div class="form-group col-md-4 ">
                                    ...
                                    <textarea readonly class="form-control" id="edit_description" name="edit_description" rows="3"
                                        style="background-color: rgba(10, 4, 27, 0.7); color:azure">{{ $edit_description}}</textarea>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea class="form-control" wire:model="edit_feedback" id="edit_feedback" name="edit_feedback" rows="3"></textarea>
                                    @error('edit_feedback')
                                        <span class="text-danger"
                                            style="font-size: 11.5px;">{{ $message }}</span>
                                    @enderror
                ...
                <div class="modal-content">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <table class="table table-hover table-bordered table-hover p-0 my-table-assign-control mt-1"
                            ...
                            <thead>
                                <tr style="background-color: rgba(0, 0, 0, 0.9); color:azure">
                                    <th>Action</th>
                                    <th>Runing Assign</th>
                                    <th>Assign ID</th>
                                    ...
                                    @foreach ($Assigned_SubTasks as $subtasks)
                                        @if (!empty($subtasks->current_processor))
                                            <tr>
                                                ...
                                                <td style="color: azure; background-color:rgb(58, 2, 55);">
                                                ...
                                                <td style="color: azure; background-color:rgb(2, 52, 15);">
                                                ...
                                                <td
                                                    style="background-color:rgb(6, 5, 56); color:azure; font-size:10px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-primary"
                            wire:click="getSelectedOwnersEdit">Select
                            Confirm</button>
                        <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal"
        ...
        <div wire:ignore.self class="modal fade" id="viewSupportEditSearchModal" tabindex="-1"
            data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="modelTitleId"
            aria-hidden="true">
            <div class="modal-dialog modal-l" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-primary"
                            wire:click="getSelectedSupportsEdit">Select
                            Confirm</button>
                        <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-4 pb-4">
                        ...
                        <form wire:submit.prevent="CancelSubTaskConfirmed">
                            ...
                            <div class="form-group col-md-12">
                                <label for="subtask_cancel_description" style="color: rgb(204, 198, 213)"> Please
                                    Mention
                                    Cancel
                                    Description</label>
                        ...
                        <form wire:submit.prevent="CompleteSubTaskConfirmed">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="subtask_fail" wire:model="subtask_fail">
                                        <label class="form-check-label" for="subtask_fail" style="color: rgb(204, 198, 213)">
