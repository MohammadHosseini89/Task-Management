...
class TaskManagementControlLivewireComponent extends Component
{
    use WithFileUploads;
    ...
    public function render(Request $request)
    {
        ...
        return view('livewire.task-management-control-livewire-component', [
    ...
    {
        $this->modalMytasks = subTask::where('id', '=', $id)->first();
    ...
    public function viewDetailsLogsubtask($id)
    {

        $this->subtasklogmodal = $this->mytasks_tasklog->where('id', '=', $id)->first();
        $this->dispatchBrowserEvent('show-view-log-subtask-modal');
    }

    //close Log Subtask modals
    public function closeLogsubtaskModal()
    {
        $this->dispatchBrowserEvent('close-view-log-subtask-modal');
    }

    //close Subtask modals
