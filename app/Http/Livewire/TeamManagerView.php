...

{
    ...
    public function render(Request $request)
    {
        ...
        $viewDetailsDispatchedByMe = TaskManagementModel::where('createdbyteam', '=', $teams)
        ...
        return view('livewire.team-manager-view', [
    ...
    public function mount(Request $request)
    {
        ...
        $this->dispatchedbyme_taskmanagementmodel = TaskManagementModel::where('createdbyteam', '=', $teams)
            ->orderBy('latest_update', 'desc')
            ->get();
    ...
    public function updated($fields)
    {
        $this->validateOnly($fields, [
            ...
            'edit_solution3' => 'nullable|string|max:255',
